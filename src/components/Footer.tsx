export function Footer() {
  return (
    <footer
      style={{
        borderTop: '1px solid var(--content-secondary)',
        padding: '1rem var(--main-padding)',
        marginTop: '2rem',
      }}
    >
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.75rem' }}>
        <p style={{ margin: 0, color: 'var(--content-secondary)' }}>ꕀ Powered by caffeine and occasional epiphany. ꕀ</p>
        ...
        <a
          ...
          aria-label="LinkedIn"
          style={{ color: 'var(--content-secondary)', display: 'flex' }}
        >
        ...
        {/* Email */}
        <a
          href="mailto:sagar@smallstep.ai?subject=Hi%20Sagar"
          aria-label="Email"
          style={{ color: 'var(--content-secondary)', display: 'flex' }}
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
